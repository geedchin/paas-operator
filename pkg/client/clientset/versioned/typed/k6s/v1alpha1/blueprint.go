...
import (
	...
	scheme "github.com/farmer-hutao/k6s/pkg/client/clientset/versioned/scheme"
...
type BlueprintInterface interface {
	...
	UpdateStatus(*v1alpha1.Blueprint) (*v1alpha1.Blueprint, error)
...
func newBlueprints(c *K6sV1alpha1Client, namespace string) *blueprints {
	return &blueprints{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *blueprints) UpdateStatus(blueprint *v1alpha1.Blueprint) (result *v1alpha1.Blueprint, err error) {
	result = &v1alpha1.Blueprint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("blueprints").
