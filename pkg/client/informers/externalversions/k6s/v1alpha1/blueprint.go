...
import (
	...
	v1alpha1 "github.com/farmer-hutao/k6s/pkg/client/listers/k6s/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.K6sV1alpha1().Blueprints(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.K6sV1alpha1().Blueprints(namespace).Watch(options)
			},
		},
		&k6sv1alpha1.Blueprint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *blueprintInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&k6sv1alpha1.Blueprint{}, f.defaultInformer)
}
